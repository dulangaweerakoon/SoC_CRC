...
HD_PWD='D:/ADS/SoC_intr_cache_V2/SoC_intr_cache_V2.runs/design_1_myiphwac_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myiphwac_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myiphwac_0_0.tcl
