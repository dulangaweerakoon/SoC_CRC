...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M01_AXI [get_bd_intf_pins axi_mem_intercon/M01_AXI] [get_bd_intf_pins myiphwac_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M02_AXI [get_bd_intf_pins axi_mem_intercon/M02_AXI] [get_bd_intf_pins myiphwac_0/S_AXI_INTR]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/M03_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins myiphwac_0/s00_axi_aresetn] [get_bd_pins myiphwac_0/s_axi_intr_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_cache_0/ARESETN]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x80020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80010000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs myiphwac_0/S_AXI_INTR/S_AXI_INTR_reg] SEG_myiphwac_0_S_AXI_INTR_reg
